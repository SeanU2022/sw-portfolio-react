  ...
  return (
    <div>
      <div>
        <h2>Contact Page</h2>
        <p>
          Please contact me by submitting your message
        </p>
      </div>
      ...
      <form className="form">
        ...
        {/* <input value={password} name="password" onChange={(e) => setPassword(e.target.value)} type="text" placeholder="password"/> */}
        <input value={password} name="password" onChange={handleInputChange} type="text" placeholder="message"/>
